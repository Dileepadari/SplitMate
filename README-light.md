...
<table>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/01-dashboard.png" alt="Dashboard: totals owed and owing, the group list and recent activity" loading="lazy">
      <p align="center"><b>Dashboard</b><br><sub>Every group, what you are owed and what you owe, and recent activity.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/02-group.png" alt="Group page: suggested payments above the balance table they came from" loading="lazy">
      <p align="center"><b>Inside a group</b><br><sub>Who owes whom, above the ledger those numbers came from.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/03-add-expense.png" alt="Add expense: a weighted share split with live per-person amounts" loading="lazy">
  ...
  <tr>
    ...
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/05-members.png" alt="Members: roles, join dates, balances and the add-member form" loading="lazy">
...
<br>
<img src="./docs/screenshots/light/07-settings.png" alt="Settings with profile, password and preferred currency" loading="lazy">
</details>
